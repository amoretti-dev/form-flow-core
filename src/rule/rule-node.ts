...
export type RuleNodeHelpersResult = {
    state: RuleNodeState;
}

export const createRuleNodeHelpers = <TFieldControlType extends string = never>() => {
    ...
    ): RuleNodeHelpersResult & { rules: FieldRuleNode[] } => {
    ...
    const updateRule = (
        ...
        parentGroupId: string,
        rule: FieldRuleDefinition,
    ): RuleNodeHelpersResult & { rootGroup: FieldRuleGroupDefinition } => {
