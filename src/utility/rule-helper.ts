...
import { FormFlowPrimitivesHelper } from "./primitives-helper";
...
export class RuleHelper {
  ...
  static findGroup(
    groupId: string,
    group: FieldRuleGroupDefinition,
  ): FieldRuleGroupDefinition | undefined {
  ...
  static createRule(field: BaseFieldDefinition): FieldRuleDefinition {
    return {
      ruleId: generateId(),
      conditionFieldId: field.id,
      operator: "eq",
      value: FormFlowPrimitivesHelper.getFieldTypeDefaultValue(field.type),
    };
  }
}
